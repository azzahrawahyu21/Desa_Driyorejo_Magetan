...
<head>
  ...
  <title>Lembaga Pemberdayaan Masyarakat Desa (LPMD)</title>
  ...
  <div class="container" style="margin-top:-180px; z-index:5; position:relative;">
    ...
    <div class="card p-4 bg-white" 
      ...
      <div class="text-center mb-4">
        <img src="{{ asset('assets/img/lembaga/logo_lpm.png') }}" class="img-fluid" alt="logo">
      </div>

      <p>
        <strong>Lembaga Pemberdayaan Masyarakat (LPM)</strong> adalah organisasi yang dibentuk untuk 
        memberdayakan masyarakat di tingkat desa. LPM dibentuk atas prakarsa masyarakat.
      </p>

      <!-- Row untuk 2 Card Program Kerja -->
      <div class="row mt-4">
        <!-- Card kiri -->
        <div class="col-md-6 mb-3">
          <div class="card p-3 h-100" style="border-radius:15px; box-shadow: 0 4px 15px rgba(13, 71, 21, 0.4);">
            <h6 class="text-center text-success fw-bold mt-2">TUGAS LPMD</h6>
            <div class="mt-3">
                <ol>
                    ...
                    <li>Menampung dan menyalurkan aspirasi masyarakat dalam pembangunan.</li>
                    <li>Meningkatkan kualitas dan percepatan pelayanan pemerintah kepada masyarakat.</li>
                    <li>Mengembangkan kemitraan</li>
                </ol>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-3">
          <div class="card p-3 h-100" style="border-radius:15px; box-shadow: 0 4px 15px rgba(13, 71, 21, 0.4);">
            <h6 class="text-center text-success fw-bold mt-2">TUJUAN LPMD</h6>
            <div class="mt-3">
                <ol>
                    <li>Menciptakan masyarakat yang mandiri dan berdaya saing.</li>
                    <li>Meningkatkan partisipasi dan pelayanan penyelenggaraan masyarakat desa.</li>
                    <li>Ikut serta dalam perencanaan, pelaksanaan, dan pembangunan yang dilakukan oleh Pemerintah Desa.</li>
                    <li>Program LPM Pendidikan dan pelatihan, Program kesehatan masyarakat, Program pemberdayaan ekonomi.</li>
                </ol>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 offset-md-3 mb-3">
            <div class="card p-3 h-100" style="border-radius:15px; box-shadow: 0 4px 15px rgba(13, 71, 21, 0.4);">
                <h6 class="text-center text-success fw-bold mt-2">HUBUNGAN KERJA LPMD</h6>
                <div class="mt-3">
                    <ol>
                        <li>Dengan Pemerintah, Desa bersifat konsultatif dan koordinatif.</li>
                        <li>Dengan Lembaga kemasyarakatan lainnya di Kelurahan bersifat koordinatif dan konsultatif.</li>
                        <li>Dengan pihak ketiga di Desa bersifat kemitraan.</li>
                    </ol>
                </div>
            </div>
        </div>
