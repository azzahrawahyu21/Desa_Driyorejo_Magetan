      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm border-success h-100">
            <img src="assets/img/dashboard/umkm.png" class="card-img-top" alt="Berita 1"
              style="object-fit: cover; height: 180px;">
            <div class="card-body p-3">
              <h6 class="fw-bold mt-2">Kerajinan Tangan</h6>
              <p class="text-muted small mb-2">
                Desa Driyorejo, Kecamatan Nguntoronadi, Kabupaten Magetan tidak hanya dikenal sebagai desa agraris, tetapi juga...
              </p>
                <a href="{{ route('umkm_detail') }}" class="btn btn-outline-success btn-sm d-inline-flex align-items-center">
                Selengkapnya
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm border-success h-100">
            <img src="assets/img/dashboard/umkm.png" class="card-img-top" alt="Berita 2"
              style="object-fit: cover; height: 180px;">
            <div class="card-body p-3">
              <h6 class="fw-bold mt-2">Kerajinan Tangan</h6>
              <p class="text-muted small mb-2">
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm border-success h-100">
            <img src="assets/img/dashboard/umkm.png" class="card-img-top" alt="Berita 3"
              style="object-fit: cover; height: 180px;">
            <div class="card-body p-3">
              <h6 class="fw-bold mt-2">Kerajinan Tangan</h6>
              <p class="text-muted small mb-2">
